...
public class MainActivity extends AppCompatActivity {
    ...
    //Link to java class MessageReceiver
    BroadcastReceiver br = new MessageReceiver();

    //Close the app / destroy the app unregister broadcast receiver
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
                    ...
                    //Intent to open the message app
        ...
        //Enhancement 2 send one message to multiple numbers
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            Toast.makeText(MainActivity.this,
                ...
                //setText empty the content field after sending
                etcontent.setText("");
            }
